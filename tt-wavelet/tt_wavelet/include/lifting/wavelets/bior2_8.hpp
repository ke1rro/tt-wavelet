...
inline constexpr auto bior2_8_scheme = make_lifting_scheme(
    ...
    PredictStep<8>{ { -0.00213623046875f, 0.020446777343750003f, -0.095397949218750014f, 0.32708740234375f, 0.32708740234375f, -0.095397949218750014f, 0.020446777343750003f, -0.00213623046875f }, -3 },
    SwapStep{ {}, 0 },
