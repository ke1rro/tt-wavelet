...
inline constexpr auto bior1_5_scheme = make_lifting_scheme(
    ...
    UpdateStep<5>{ { -0.011718749999999998f, 0.085937499999999986f, 0.49999999999999994f, -0.085937499999999986f, 0.011718749999999998f }, -2 },
    ScaleEvenStep<1>{ { 1.4142135623730951f }, 0 },
    ScaleOddStep<1>{ { 0.70710678118654746f }, 0 }
);
