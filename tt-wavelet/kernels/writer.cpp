...
void kernel_main() {
    ...
    // Для тесту читаємо безпосередньо з вхідного CB (куди пише reader)
    ...
    for (uint32_t i = 0; i < num_tiles; i++) {
        // Чекаємо, поки reader заповнить тайл
