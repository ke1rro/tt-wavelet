...
inline constexpr auto rbio2_6_scheme = make_lifting_scheme(
    ...
    3,
    4,
    PredictStep<2>{{0.50000000000000011f, 0.50000000000000011f}, {0x3f000000u, 0x3f000000u}, 0},
    SwapStep{{}, {}, 0},
    PredictStep<6>{
        {-0.0097656249999999983f,
         ...
         0.076171874999999972f,
         -0.0097656249999999983f},
        {0xbc200000u, 0x3d9c0000u, 0xbea20000u, 0xbea20000u, 0x3d9c0000u, 0xbc200000u},
        -3},
