...
inline constexpr auto bior3_1_scheme = make_lifting_scheme(
    ...
    UpdateStep<2>{{1.1250000000000002f, -0.37500000000000006f}, {0x3f900000u, 0xbec00000u}, 0},
    PredictStep<1>{{-0.44444444444444442f}, {0xbee38e39u}, 0},
    ScaleEvenStep<1>{{0.94280904158206336f}, {0x3f715befu}, 0},
    ScaleOddStep<1>{{1.0606601717798214f}, {0x3f87c3b6u}, 0});
