...
inline constexpr auto rbio4_4_scheme = make_lifting_scheme(
    ...
    2,
    3,
    PredictStep<2>{{1.5861343420367127f, 1.5861343420367127f}, 0},
    UpdateStep<2>{{0.052980118574844914f, 0.052980118574844914f}, -1},
    PredictStep<2>{{-0.88291107550920522f, -0.88291107550920522f}, 0},
    SwapStep{{}, 0},
    PredictStep<2>{{-0.44350685204873624f, -0.44350685204873624f}, -1},
    ScaleEvenStep<1>{{0.86986445162473958f}, 0},
    ScaleOddStep<1>{{-1.1496043988602962f}, 0});
