...
inline constexpr auto db2_scheme = make_lifting_scheme(
    ...
    1,
    1,
    PredictStep<1>{{-0.57735026918962584f}, {0xbf13cd3au}, -1},
    UpdateStep<2>{{0.20096189432334197f, 0.43301270189221924f}, {0x3e4dc8f4u, 0x3eddb3d7u}, 0},
    PredictStep<1>{{-0.33333333333333331f}, {0xbeaaaaabu}, 0},
    ScaleEvenStep<1>{{1.1153550716504106f}, {0x3f8ec3f4u}, 0},
    ScaleOddStep<1>{{0.89657547216805344f}, {0x3f6585f8u}, 0});
