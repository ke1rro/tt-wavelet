...
inline constexpr auto sym3_scheme = make_lifting_scheme(
    ...
    1,
    2,
    PredictStep<1>{{2.4254972439264524f}, 0},
    UpdateStep<2>{{-0.35238765767323654f, -0.26604223490661466f}, 0},
    PredictStep<2>{{2.8953474541226774f, -14.931981221241225f}, -1},
    SwapStep{{}, 0},
    PredictStep<1>{{0.066227766012329339f}, 0},
    ScaleEvenStep<1>{{0.083742580129641767f}, 0},
    ScaleOddStep<1>{{-11.941356457514223f}, 0});
