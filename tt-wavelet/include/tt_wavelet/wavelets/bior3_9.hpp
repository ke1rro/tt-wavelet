...
inline constexpr auto bior3_9_scheme = make_lifting_scheme(
    20,
    5,
    5,
    PredictStep<1>{{-0.33333333333333331f}, {0xbeaaaaabu}, -1},
    UpdateStep<2>{{-1.1250000000000002f, -0.375f}, {0xbf900000u, 0xbec00000u}, 0},
    PredictStep<9>{
...
template <>
struct scheme_traits<bior3_9_tag> {
    using SchemeType = decltype(bior3_9_scheme);
