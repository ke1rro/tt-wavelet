...
You may install any cli tools you need. 

Here are some great directories of tt-metal which privode maybe some usefull info. 
[convolution](tt-metal/ttnn/cpp/ttnn/operations/conv)
[sfpi examples](tt-metal/tt_metal/hw/ckernels/wormhole_b0/metal/llk_api/llk_sfpu)
[tech-reports](tt-metal/tech_reports)
[some like that](tt-metal/tech_reports/Handling_Special_Value/special_values.md)

Also do not hesitate to read some tt-metal dir docs.

Really Helpfull maybe the tt-isa-documentation
