...
// The five planner-managed planes occupy non-overlapping ranges in one static
// workspace CB. Cached schemes can therefore reuse the same local L1 address
// space instead of retaining private allocator-owned L1 buffers.
