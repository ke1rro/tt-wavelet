...
int main() {
    ...
    std::string reader{"stencil_test/kernels/dataflow/stencil_read.cpp"};
    std::string writer{"stencil_test/kernels/dataflow/stencil_write.cpp"};
    std::string compute{"stencil_test/kernels/stencil_compute.cpp"};
