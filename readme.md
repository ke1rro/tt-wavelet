...
| `./update.sh [Debug\|Release] [target]` | Fast rebuild of tt-wavelet only | Re-applies CMake fixes and env; target `lwt` builds the wavelet executable. Does **not** run tt-metal install_dependencies. |
